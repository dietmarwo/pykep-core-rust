...
The Taylor extension adds closed-form recurrence tests, matched DOP853
trajectories for all eleven built-in model types, and a separate official
heyoka 7.10.1 fixture for Kepler, CR3BP, BCP, and the Kepler STM.
